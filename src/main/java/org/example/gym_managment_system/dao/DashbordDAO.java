...
public class DashbordDAO {
    ...
    public void getData(Model model) {
        ...
        try (Connection conn = DBConnection.getConnection()) {
            ...
            System.out.println("Trainer Count: " + trainerCount);
            ...
            String query5 = "SELECT p.*, m.memberName AS Mname " + "FROM payments p " + "JOIN member m ON m.id = p.member_id";
            ...
            System.out.println("Payment Amount: " + payments);
